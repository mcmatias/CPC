...
public class Cliente {
	...
	public boolean conectarAoservidor() {
        ...
        try {
            ...
            System.out.println("[ESTEIRA] - Conectado");
            return true;           
        } catch (UnknownHostException e) {
            System.err.println("[ESTEIRA] - Host desconhecido: " + IPhost);
            System.exit(1);
        } catch (IOException e) {
            System.err.println("[ESTEIRA] - Não pude me conectar ao host: " + IPhost);
            return false;
            //System.exit(1);
        }
        return false;
...
public class Cliente extends Thread {
	...
	public boolean conectarAoservidor() {
		...
		try {
			...
			System.out.println("[ESTEIRAA] - Conectado");
			return true;
		} catch (UnknownHostException e) {
			System.err.println("[ESTEIRAA] - Host desconhecido: " + IPhost);
			System.exit(1);
		} catch (IOException e) {
			System.err.println("[ESTEIRAA] - Não pude me conectar ao host: "
					+ IPhost);
			return false;
			// System.exit(1);
		}
